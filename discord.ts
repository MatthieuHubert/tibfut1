...
const updateNamesCommand: ApplicationCommandOptionsSubCommand = {
    name: "un",
    description: "[ADMIN] update database using playerdump files",
    type: Constants.ApplicationCommandOptionTypes.SUB_COMMAND
}

const freeTradeCommand: ApplicationCommandOptionsSubCommand = {
    name: "ft",
    description: "[ADMIN] free trades",
    type: Constants.ApplicationCommandOptionTypes.SUB_COMMAND,
    options: [
        {
            name: "a",
            description: "amount of free trades",
...
const setPacksCommand: ApplicationCommandOptionsSubCommand = {
    name: "sp",
    description: "[ADMIN] sets packs that are in trades",
    type: Constants.ApplicationCommandOptionTypes.SUB_COMMAND,
    options: [
        {
            name: "p",
            description: "packs, enter them with a dot between each pack",
            type: Constants.ApplicationCommandOptionTypes.STRING,
            required: true
        }
    ]
...
const walletCommand: ApplicationCommandOptionsSubCommand = {
    ...
    options: [
        {
            name: "page",
            description: "[optional] The page you want to display",
            type: Constants.ApplicationCommandOptionTypes.INTEGER
        }
    ]
}
...
const depositCommand: ApplicationCommandOptionsSubCommand = {
    ...
    options: [
        {
            name: "multiple",
            description: "[optional] Whether you want to make multiple deposits in one go",
...
const queryCommand: ApplicationCommandOptionsSubCommand = {
    name: 'q',
    description: "[ADMIN] run a query",
    type: Constants.ApplicationCommandOptionTypes.SUB_COMMAND,
    options: [
        {
            name: "q",
            description: "[ADMIN] enter the query here",
            type: Constants.ApplicationCommandOptionTypes.STRING,
            required: true
        }
    ]
...
const mainCommand: Eris.ApplicationCommandStructure = {
    name: "madfut",
    description: "The main Discfut bot command",
...
function handleAdminCommand(interaction: CommandInteraction) {
    if (!interaction.member!.permissions.has("administrator")) {
        interaction.createMessage({
            content: `Only members with madfut bot perms role can use this command. git gud lol`,
            flags: Constants.MessageFlags.EPHEMERAL
        });
        return;
    }
